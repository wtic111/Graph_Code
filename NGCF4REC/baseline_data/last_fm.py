...
# PATH = '/mnt/lizechao/10218_yanzhao/datasets/baseline_lastfm'
# PATH = '/home/wuwu/datasets/baseline_lastfm'
PATH = '/mnt/lizechao/10218_yanzhao/datasets/lastfm'


class LastfmData(object):
    def __init__(self):
        print('----------------------------------')
        print('Get the LastFM data:')
        # root
        self.root = PATH
    ...
    def get_train_d(self):
        # train path
        path_train = os.path.join(self.root, 'lastfm_train.pkl')
    ...
    def get_test_d(self, idx):
        # test path
        path_test = os.path.join(self.root, 'lastfm_test.pkl')
