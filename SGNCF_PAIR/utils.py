...
def plt_evalution(epochs, recalls, mrrs, k, alpha, lr_emb, l2_emb, lr_gcn, l2_gcn, model_type):
    ...
    # plot title
    plt.title(model_type+'-Alpha'+str(alpha)+'_'+str(lr_emb)+'_'+str(l2_emb)+'_'+str(lr_gcn)+'_'+str(l2_gcn))

    # save
    plt.savefig(model_type+'-Alpha'+str(alpha)+'_'+str(lr_emb)+'_'+str(l2_emb)+'_'+str(lr_gcn)+'_'+str(l2_gcn)+'.png')
...
def plt_norm(epochs, emb_norms, gcn_norms, alpha, lr_emb, l2_emb, lr_gcn, l2_gcn, model_type):
    ...
    # plot title
    plt.title(model_type+'-Norm_Alpha' + str(alpha)+'_'+str(lr_emb)+'_'+str(l2_emb)+'_'+str(lr_gcn)+'_'+str(l2_gcn))

    # save
    plt.savefig(model_type+'-Norm_Alpha' + str(alpha)+'_'+str(lr_emb)+'_'+str(l2_emb)+'_'+str(lr_gcn)+'_'+str(l2_gcn)+'.png')
